...
<body>
    ...
    <table style="width:100%;">
        <tr>
            <td align="center"><br>
                <p style="font-family:poppins;color:#444446; text-align:center;font-size:8px;"><b>Tienda Mayan</p>
            </td>
        </tr>
    </table>
    <table style="width:100%;">
        <tr>
            <td align="center" style="font-size: 3px;font-family:poppins">
    ...
    <table style="width:100%;">
        <tr>
            <td align="center" style="font-size: 3px;padding-bottom: 5px;font-family:poppins">
                <p>7930 4300</p>
            </td>
        </tr>
    </table>
    ...
    <table style="width:100%;">
        <tr>
        <td align="center" style="font-size: 4px;font-family:poppins">
    ...
    <table align="center" class="mt-2 "  style="width:90%;">
        <thead>
            <tr>
                <th  style="font-size:4px;padding-bottom: 3px;  font-family:poppins" scope="col">CANT </th>
                <th align="start" style="font-size:4px;padding-bottom: 3px;font-family:poppins; width:50%;">CONCEPTO</th>
                <th  style="font-size:4px;padding-bottom: 3px; padding-rigth: 20px;font-family:poppins" scope="col">P.U.</th>
                <th  style="font-size:4px;padding-bottom: 3px;font-family:poppins" scope="col">IMPORTE</th>
            </tr>
        </thead>
        <tbody>
            <?php foreach ($detalle as $fila): ?>
                <tr>
                    <th style="font-size: 3px;font-family:poppins;color:#444446;">
                        <?php echo $fila['cantidad']; ?>
                    </th>
                    <th align="start"  style="font-size: 3px;font-family:poppins;color:#444446;">
                    <?php echo $fila['nombre'];  ?>
                    </th>
                    <th style="font-size: 3px;font-family:poppins;color:#444446;">Q.
    ...
    <table style="width:100%;">
        <tr>
            <td align="center">
                <p style="font-size: 5px;font-family:poppins;color:#444446;font-weight:bold;padding-top:50px"> ..::::::
